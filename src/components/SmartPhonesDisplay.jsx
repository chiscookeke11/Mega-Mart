...
const SmartPhonesDisplay = () => {
  ...
  return (
    <div className='mx-auto mt-5 w-full my-3 bg-white px-[7%] text-sm lg:text-base min-h-[20vh]' >
        ...
        <div className="display-box grid grid-cols-2 lg:grid-cols-auto md:grid-cols-auto  gap-4 gap-y-6  flex-wrap py-5 px-2 ">
        ...
        {phones.slice(0, sliced).map((item, index)=> {
          ...
          return(
            <div key={index} className="item lg:w-[200px] md:w-[180px] h-[275px] w-[150px] min-w-[130px] min-h-[220px] bg-white rounded-[16px] text-xs flex flex-col justify-start gap-2 overflow-hidden border relative border-[#EDEDED] mx-auto my-3 cursor-pointer duration-300 hover:border-[#008ECC] transition-all transform hover:scale-105">
          ...
          <div className='px-3  ' >
            <h2 className='text-[#222222] font-semibold my-1 text-xs' >{item.name} </h2>
          ...
          <h5 className='w-full px-3 py-2 text-[#249B3E] border-t border-[#EDEDED] font-bold ' >Save - ₹{discount}</h5>
