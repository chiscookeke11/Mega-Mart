    ...
    <div className='mx-auto  w-full my-[5%] bg-white px-[7%] text-sm lg:text-md min-h-[20vh]' >
            ...
            <div className="display my-7 flex flex-row items-center justify-evenly overflow-x-auto">
               ...
               {topCategories.map((category, index)=> (
                 <div className='bg-transparent w-[135px] flex items-center justify-center flex-col p-2 gap-1 mx-1 my-2 ' >
                 <div className='w-[110px] h-[110px] rounded-[50%] bg-[#F5F5F5] flex items-center justify-center' > 
